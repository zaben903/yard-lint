...
RSpec.describe Yard::Lint::Validators::Warnings::DuplicatedParameterName::Parser do
  let(:parser) { described_class.new }

  describe '#initialize' do
    it 'inherits from OneLineBase parser' do
      expect(parser).to be_a(Yard::Lint::Parsers::OneLineBase)
    end
  end
