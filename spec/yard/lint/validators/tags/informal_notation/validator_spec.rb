...
RSpec.describe Yard::Lint::Validators::Tags::InformalNotation::Validator do
  ...
  describe '.in_process_visibility' do
    it 'returns :public' do
      expect(described_class.in_process_visibility).to eq(:public)
    end
  end
end
